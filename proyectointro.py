...
"""
Aplicación Streamlit para generar introducciones de tesis.
Funciona en dos modos:
1️⃣ **Modo LLM (recomendado)** – Usa un modelo instructivo de Hugging Face. Necesitas un `HF_TOKEN`.
2️⃣ **Modo Simple (sin token)** – Genera texto basado en plantillas básicas. Útil para pruebas offline.
"""

# ---------------- Configuración por defecto ---------------- #

DEFAULT_MODEL_ID = "mistralai/Mistral-7B-Instruct-v0.2"
DEFAULT_HF_TOKEN = st.secrets.get("HF_TOKEN", "")  # ← vacío si no se configuró
...
def simple_paragraph(text: str) -> str:
    """Ajusta el texto para que no exceda 10 líneas (~120 palabras aprox.)."""
